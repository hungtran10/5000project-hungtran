...
- **Goals**: The goal of this project is to extract insights on customer's preferences for online vs. in-person shopping through various machine learning modeling techniques to inform businesses of their online and in-store presence. I want to be able to learn how to use data collected to train models to predict outcomes and potentially have an impact on how business conduct strategic decision-making. 
