...
1. **Data Analysis and Insights**:  
   ...
   - Spending patterns also varied across racial groups, with Asians spending significantly more online, hinting at cultural or access-related trends.  
...
3. **Test Location and Segment-Specific Strategies**:  
   ...
   - For instance, test the effectiveness of location-specific online promotions for high-income customers or in-store campaigns for segments preferring physical shopping.
